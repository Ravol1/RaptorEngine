...
namespace raptor::interpreter::graphic::detail {
	namespace {
		...
		auto apply_position(Layer* layerObj, Layer::LayerPage page, const std::string& left, const std::string& top) -> void {
		...
		auto apply_opacity(Layer* layerObj, Layer::LayerPage page, const std::string& opacity) -> void {
